    ...
    <div className="min-h-screen">
        ...
        <div className="relative px-6 py-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-red-200/70 mt-1">Bem-vindo ao painel de controle da GT Veículos</p>
            </div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Vendas do Mes */}
          <Card className="bg-gradient-to-br from-red-600 to-red-700 border-0 shadow-2xl shadow-red-500/25 overflow-hidden relative group">
            ...
            <CardContent className="relative p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-red-100/80 text-sm font-medium">Vendas do Mes</p>
          ...
          {/* Veiculos em Estoque */}
          <Card className="bg-gradient-to-br from-gray-600 to-gray-700 border-0 shadow-2xl shadow-gray-500/25 overflow-hidden relative group">
            <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent" />
            <div className="absolute -right-8 -top-8 w-32 h-32 bg-white/10 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-500" />
            <CardContent className="relative p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-100/80 text-sm font-medium">Veiculos em Estoque</p>
                  <p className="text-3xl font-bold text-white mt-1">
                    {stats.vehicles}
                  </p>
                  <div className="flex items-center gap-2 mt-2">
                    <span className="text-gray-200/80 text-xs">Disponiveis para venda</span>
                  </div>
                </div>
                <div className="w-14 h-14 bg-white/20 rounded-2xl flex items-center justify-center backdrop-blur-sm">
          ...
          {/* Propostas Pendentes */}
          <Card className="bg-gradient-to-br from-amber-600 to-amber-700 border-0 shadow-2xl shadow-amber-500/25 overflow-hidden relative group">
            <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent" />
            <div className="absolute -right-8 -top-8 w-32 h-32 bg-white/10 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-500" />
            <CardContent className="relative p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-amber-100/80 text-sm font-medium">Propostas Pendentes</p>
                  <p className="text-3xl font-bold text-white mt-1">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    {stats.pendingProposals === 0 && (
                      <span className="text-amber-200/80 text-xs">Nenhuma pendente</span>
                    )}
                  </div>
                </div>
                <div className="w-14 h-14 bg-white/20 rounded-2xl flex items-center justify-center backdrop-blur-sm">
          ...
          <Card className="bg-slate-900/60 border-slate-700/50 backdrop-blur-sm hover:bg-slate-900/80 transition-all duration-300 group">
            <CardContent className="p-5">
              <div className="flex items-center gap-4">
                ...
                <Badge className="ml-auto bg-red-500/20 text-red-400 border-0">
                  Clientes
                </Badge>
              </div>
            </CardContent>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="lg:col-span-2 bg-slate-900/60 border-slate-700/50 backdrop-blur-sm">
            <CardHeader className="border-b border-slate-700/50">
              <div className="flex items-center justify-between">
                ...
                <Button variant="ghost" size="sm" className="text-red-400 hover:text-red-300 hover:bg-red-500/10" asChild>
                ...
                {stats.recentVehicles.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="text-slate-400">Nenhum veiculo cadastrado ainda</p>
                      <Button variant="link" asChild className="mt-2 text-red-400">
                  ...
                  stats.recentVehicles.map((vehicle: any) => (
                    <div key={vehicle.id} className="flex items-center justify-between p-4 hover:bg-slate-800/50 transition-colors">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-gradient-to-br from-red-500/20 to-gray-500/20 rounded-xl flex items-center justify-center">
          ...
          <Card className="bg-slate-900/60 border-slate-700/50 backdrop-blur-sm">
            ...
            <CardContent className="p-4 space-y-3">
              <Button className="w-full justify-start bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 border-0 text-white shadow-lg shadow-red-500/25" asChild>
                <Link href="/admin/vehicles/new">
                  <Car className="h-4 w-4 mr-2" />
                  Cadastrar Veiculo
                </Link>
              </Button>
              <Button className="w-full justify-start bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-500 hover:to-amber-600 border-0 text-white shadow-lg shadow-amber-500/25" asChild>
                <Link href="/admin/proposals">
                  <FileText className="h-4 w-4 mr-2" />
                  Ver Propostas
                </Link>
              </Button>
              <Button className="w-full justify-start bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-500 hover:to-gray-600 border-0 text-white shadow-lg shadow-gray-500/25" asChild>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        {inquiry.vehicle_name && (
                          <p className="text-red-400 text-xs mt-0.5">Interesse: {inquiry.vehicle_name}</p>
                        )}
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      ...
                      <Badge className={
                        ...
                        inquiry.status === "contacted" ? "bg-red-500/20 text-red-400 border-0" :
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="bg-gradient-to-br from-slate-900 to-slate-800 border-slate-700/50 overflow-hidden">
            <CardContent className="p-5">
              <div className="flex items-center justify-between mb-4">
                ...
                <Badge className="bg-red-500/20 text-red-400 border-0 text-xs">Tempo Real</Badge>
              </div>
              ...
              <div className="mt-3 flex items-center gap-2">
                <div className="flex-1 h-1.5 bg-slate-700 rounded-full overflow-hidden">
                  <div className="w-[65%] h-full bg-gradient-to-r from-red-600 to-red-400 rounded-full" />
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-slate-900 to-slate-800 border-slate-700/50 overflow-hidden">
            <CardContent className="p-5">
              ...
              <p className="text-gray-400 text-sm mt-1">+12% vs ontem</p>
            </CardContent>
          </Card>
